...
$string['config_display_convenor_options_help'] = 'The options chosen here will be displayed in the Module Info block. They will only be displayed if you have added the information to your Moodle profile. To select or de-select options from the list please Ctrl + left mouse click (windows), Cmd + Click on Mac';
