	...
	Y.use('yui2-treeview', function(Y) {
		function hide_additional_teachers(e) {
			if(additional_teachers_heading) {
				...
				additional_teachers_heading.detach('click', hide_additional_teachers, false);
				additional_teachers_heading.on('click', show_additional_teachers, this);
			}
		}
		...
		function show_additional_teachers(e) {
			if(additional_teachers_heading) {
				...
				// Attach new event handler
				additional_teachers_heading.detach('click', show_additional_teachers, false);
		...
		function hide_documents(e) {
			if(documents_heading) {
				...
				// Attach new event handler
				documents_heading.detach('click', hide_documents, false);
				documents_heading.on('click', show_documents, this);
			}
		}
		...
		function show_documents(e) {
			if(documents_heading) {
				...
				// Attach new event handler
				documents_heading.detach('click', show_documents, false);
		...
		function hide_schedule(e) {
			if(schedule_heading) {
				...
				// Attach new event handler
				schedule_heading.detach('click', hide_schedule, false);
				schedule_heading.on('click', show_schedule, this);
			}
		}
		...
		function show_schedule(e) {
			if(schedule_heading) {
				...
				// Attach new event handler
				schedule_heading.detach('click', show_schedule, false);
